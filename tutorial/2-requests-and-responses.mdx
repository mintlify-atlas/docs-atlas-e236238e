...
description: "Learn about REST framework's Request and Response objects and how to use API views"
---
...
<CardGroup cols={2}>
  <Card title="Flexible Parsing" icon="code">
    The `request.data` attribute handles JSON, form data, and file uploads automatically based on the content type.
  </Card>
  <Card title="Method Agnostic" icon="arrows-turn-to-dots">
    Works with POST, PUT, and PATCH methods, unlike `request.POST` which only works with POST.
  </Card>
</CardGroup>
...
The `Response` object automatically handles:
- Content negotiation
...
<Steps>
  <Step title="Function-based views">
...
<Note>
See the [browsable API](/topics/browsable-api) topic for more information about the browsable API feature and how to customize it.
</Note>

## What's next?

In [tutorial part 3](/tutorial/3-class-based-views), we'll start using class-based views, and see how generic views reduce the amount of code we need to write.
